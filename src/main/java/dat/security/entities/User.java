...
public class User implements Serializable, ISecurityUser {
    ...
    //verifies if the provided password (pw) matches the hashed password (this.password).
    ...
    public User(String userName, String userPass) {
        ...
        //hashes the password userPass by creating a unique hash value with BCrypt and generates a random "salt" each time, making the hash unique.
        this.password = BCrypt.hashpw(userPass, BCrypt.gensalt());
    }

    public User(String userName, Set<Role> roleEntityList) {
        this.username = userName;
        this.roles = roleEntityList != null ? roleEntityList : new HashSet<>();
    }
