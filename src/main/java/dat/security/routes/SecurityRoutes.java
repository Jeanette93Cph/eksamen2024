    ...
    public static EndpointGroup getSecuredRoutes(){
        return ()->{
            path("/protected", ()->{
                ...
                get("/users", securityController::getAll, Role.ADMIN);
                get("/users/{username}", securityController::getByUsername, Role.ADMIN);
                put("/users/{username}", securityController::updateUser, Role.ADMIN);
                delete("/users/{username}", securityController::deleteUser, Role.ADMIN, Role.USER);
            });
        };
    }
}
